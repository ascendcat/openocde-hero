export const dict = {
  ...
  "settings.webui.server.title": "Servidor da Web UI",
  "settings.webui.server.description": "Disponibiliza a interface web do OpenCode para que outros dispositivos da rede possam se conectar",
  "settings.webui.status.running": "Em execução",
  "settings.webui.status.stopped": "Parado",
  "settings.webui.action.start": "Iniciar",
  "settings.webui.action.stop": "Parar",
  "settings.webui.hostname.title": "Endereço de escuta",
  "settings.webui.hostname.description": "Interface de rede em que a Web UI escuta",
  "settings.webui.hostname.all": "Todas as interfaces (0.0.0.0)",
  "settings.webui.hostname.local": "Somente este dispositivo (127.0.0.1)",
  "settings.webui.port.title": "Porta",
  "settings.webui.port.description": "Porta da Web UI. Use 0 para escolher automaticamente uma porta livre",
  "settings.webui.mdns.title": "Descoberta mDNS",
  "settings.webui.mdns.description": "Anuncia a Web UI na rede local via mDNS",
  "settings.webui.username.title": "Nome de usuário",
  "settings.webui.username.description": "Nome de usuário para entrar na Web UI",
  "settings.webui.password.title": "Senha",
  "settings.webui.password.description": "Deixe em branco para permitir acesso sem login",
  "settings.webui.restart.hint": "As alterações nessas configurações são aplicadas após parar e iniciar o servidor novamente",
  "settings.webui.auth.warning": "Nenhuma senha definida. Qualquer pessoa que alcançar essas URLs pode controlar o OpenCode. Defina a variável de ambiente OPENCODE_SERVER_PASSWORD para exigir login.",
  "settings.webui.credentials.title": "Credenciais de acesso",
  "settings.webui.credentials.description": "Necessárias ao abrir essas URLs em um navegador",
  "settings.webui.section.urls": "URLs de acesso",
  "settings.webui.urls.empty": "Inicie o servidor para obter URLs compartilháveis",
  "settings.webui.section.connections": "Clientes conectados",
  "settings.webui.connections.empty": "Nenhum cliente conectado",
  "settings.webui.connections.requests": "{{count}} requisições",
  "settings.webui.error.start": "Falha ao iniciar o servidor da Web UI",
  "settings.webui.error.stop": "Falha ao parar o servidor da Web UI",
