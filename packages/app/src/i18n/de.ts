...
export const dict = {
  ...
  "settings.webui.server.title": "Web-UI-Server",
  "settings.webui.server.description": "Stellt die OpenCode-Weboberfläche bereit, damit andere Geräte im Netzwerk sich verbinden können",
  "settings.webui.status.running": "Läuft",
  "settings.webui.status.stopped": "Gestoppt",
  "settings.webui.action.start": "Starten",
  "settings.webui.action.stop": "Stoppen",
  "settings.webui.hostname.title": "Listen-Adresse",
  "settings.webui.hostname.description": "Netzwerkschnittstelle, auf der die Web-UI lauscht",
  "settings.webui.hostname.all": "Alle Schnittstellen (0.0.0.0)",
  "settings.webui.hostname.local": "Nur dieses Gerät (127.0.0.1)",
  "settings.webui.port.title": "Port",
  "settings.webui.port.description": "Port für die Web-UI. 0 wählt automatisch einen freien Port",
  "settings.webui.mdns.title": "mDNS-Erkennung",
  "settings.webui.mdns.description": "Die Web-UI im lokalen Netzwerk per mDNS bekannt machen",
  "settings.webui.username.title": "Benutzername",
  "settings.webui.username.description": "Benutzername für die Anmeldung an der Web-UI",
  "settings.webui.password.title": "Passwort",
  "settings.webui.password.description": "Leer lassen, um Zugriff ohne Anmeldung zu erlauben",
  "settings.webui.restart.hint": "Änderungen an diesen Einstellungen gelten nach dem Stoppen und erneuten Starten des Servers",
  "settings.webui.auth.warning": "Es ist kein Passwort gesetzt. Jeder, der diese URLs erreichen kann, kann OpenCode steuern. Setzen Sie die Umgebungsvariable OPENCODE_SERVER_PASSWORD, um eine Anmeldung zu verlangen.",
  "settings.webui.credentials.title": "Anmeldedaten",
  "settings.webui.credentials.description": "Erforderlich beim Öffnen dieser URLs im Browser",
  "settings.webui.section.urls": "Zugriffs-URLs",
  "settings.webui.urls.empty": "Starten Sie den Server, um teilbare URLs zu erhalten",
  "settings.webui.section.connections": "Verbundene Clients",
  "settings.webui.connections.empty": "Keine Clients verbunden",
  "settings.webui.connections.requests": "{{count}} Anfragen",
  "settings.webui.error.start": "Web-UI-Server konnte nicht gestartet werden",
  "settings.webui.error.stop": "Web-UI-Server konnte nicht gestoppt werden",
