export const dict = {
  ...
  "settings.webui.server.title": "خادم واجهة الويب",
  "settings.webui.server.description": "يوفّر واجهة OpenCode على الويب ليتمكّن الأجهزة الأخرى على الشبكة من الاتصال",
  "settings.webui.status.running": "قيد التشغيل",
  "settings.webui.status.stopped": "متوقف",
  "settings.webui.action.start": "تشغيل",
  "settings.webui.action.stop": "إيقاف",
  "settings.webui.hostname.title": "عنوان الاستماع",
  "settings.webui.hostname.description": "واجهة الشبكة التي تستمع عليها واجهة الويب",
  "settings.webui.hostname.all": "جميع الواجهات (0.0.0.0)",
  "settings.webui.hostname.local": "هذا الجهاز فقط (127.0.0.1)",
  "settings.webui.port.title": "المنفذ",
  "settings.webui.port.description": "منفذ واجهة الويب. استخدم 0 لاختيار منفذ متاح تلقائيًا",
  "settings.webui.mdns.title": "اكتشاف mDNS",
  "settings.webui.mdns.description": "الإعلان عن واجهة الويب على الشبكة المحلية عبر mDNS",
  "settings.webui.username.title": "اسم المستخدم",
  "settings.webui.username.description": "اسم المستخدم لتسجيل الدخول إلى واجهة الويب",
  "settings.webui.password.title": "كلمة المرور",
  "settings.webui.password.description": "اتركها فارغة للسماح بالوصول دون تسجيل الدخول",
  "settings.webui.restart.hint": "تُطبَّق التغييرات على هذه الإعدادات بعد إيقاف الخادم وتشغيله من جديد",
  "settings.webui.auth.warning": "لم يتم تعيين كلمة مرور. يمكن لأي شخص يصل إلى هذه الروابط التحكم في OpenCode. عيِّن متغيّر البيئة OPENCODE_SERVER_PASSWORD لطلب تسجيل الدخول.",
  "settings.webui.credentials.title": "بيانات تسجيل الدخول",
  "settings.webui.credentials.description": "مطلوبة عند فتح هذه الروابط في المتصفح",
  "settings.webui.section.urls": "روابط الوصول",
  "settings.webui.urls.empty": "شغّل الخادم للحصول على روابط قابلة للمشاركة",
  "settings.webui.section.connections": "العملاء المتصلون",
  "settings.webui.connections.empty": "لا يوجد عملاء متصلون",
  "settings.webui.connections.requests": "{{count}} طلبات",
  "settings.webui.error.start": "فشل تشغيل خادم واجهة الويب",
  "settings.webui.error.stop": "فشل إيقاف خادم واجهة الويب",
