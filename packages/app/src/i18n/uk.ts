export const dict = {
  ...
  "settings.webui.server.description": "Надає вебінтерфейс OpenCode, щоб інші пристрої в мережі могли під'єднуватися",
  "settings.webui.status.running": "Працює",
  "settings.webui.status.stopped": "Зупинено",
  "settings.webui.action.start": "Запустити",
  "settings.webui.action.stop": "Зупинити",
  "settings.webui.hostname.title": "Адреса прослуховування",
  "settings.webui.hostname.description": "Мережевий інтерфейс, на якому працює Web UI",
  "settings.webui.hostname.all": "Усі інтерфейси (0.0.0.0)",
  "settings.webui.hostname.local": "Лише цей пристрій (127.0.0.1)",
  "settings.webui.port.title": "Порт",
  "settings.webui.port.description": "Порт Web UI. Вкажіть 0, щоб автоматично вибрати вільний порт",
  "settings.webui.mdns.title": "Виявлення mDNS",
  "settings.webui.mdns.description": "Анонсувати Web UI у локальній мережі через mDNS",
  "settings.webui.username.title": "Ім'я користувача",
  "settings.webui.username.description": "Ім'я користувача для входу у Web UI",
  "settings.webui.password.title": "Пароль",
  "settings.webui.password.description": "Залиште порожнім, щоб дозволити доступ без входу",
  "settings.webui.restart.hint": "Зміни цих налаштувань набувають чинності після зупинки та повторного запуску сервера",
  "settings.webui.auth.warning": "Пароль не встановлено. Будь-хто, хто може відкрити ці URL, може керувати OpenCode. Задайте змінну середовища OPENCODE_SERVER_PASSWORD, щоб вимагати вхід.",
  "settings.webui.credentials.title": "Облікові дані для входу",
  "settings.webui.credentials.description": "Потрібні під час відкриття цих URL у браузері",
  "settings.webui.section.urls": "URL доступу",
  "settings.webui.urls.empty": "Запустіть сервер, щоб отримати посилання для спільного доступу",
  "settings.webui.section.connections": "Під'єднані клієнти",
  "settings.webui.connections.empty": "Немає під'єднаних клієнтів",
  "settings.webui.connections.requests": "Запитів: {{count}}",
  "settings.webui.error.start": "Не вдалося запустити сервер Web UI",
  "settings.webui.error.stop": "Не вдалося зупинити сервер Web UI",
