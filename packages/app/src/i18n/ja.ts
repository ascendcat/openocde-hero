export const dict = {
  ...
  "settings.webui.server.title": "Web UI サーバー",
  "settings.webui.server.description": "OpenCode のウェブインターフェースを公開し、ネットワーク上の他のデバイスから接続できるようにします",
  "settings.webui.status.running": "実行中",
  "settings.webui.status.stopped": "停止中",
  "settings.webui.action.start": "開始",
  "settings.webui.action.stop": "停止",
  "settings.webui.hostname.title": "リッスンアドレス",
  "settings.webui.hostname.description": "Web UI がリッスンするネットワークインターフェース",
  "settings.webui.hostname.all": "すべてのインターフェース (0.0.0.0)",
  "settings.webui.hostname.local": "このデバイスのみ (127.0.0.1)",
  "settings.webui.port.title": "ポート",
  "settings.webui.port.description": "Web UI のポート。0 を指定すると空きポートを自動選択します",
  "settings.webui.mdns.title": "mDNS 検出",
  "settings.webui.mdns.description": "ローカルネットワークで mDNS により Web UI を通知します",
  "settings.webui.username.title": "ユーザー名",
  "settings.webui.username.description": "Web UI のログインに使うユーザー名",
  "settings.webui.password.title": "パスワード",
  "settings.webui.password.description": "空欄の場合はログインなしでアクセスできます",
  "settings.webui.restart.hint": "これらの設定はサーバーを停止して再度開始すると適用されます",
  "settings.webui.auth.warning": "パスワードが設定されていません。これらの URL にアクセスできる人は誰でも OpenCode を操作できます。ログインを必須にするには環境変数 OPENCODE_SERVER_PASSWORD を設定してください。",
  "settings.webui.credentials.title": "ログイン資格情報",
  "settings.webui.credentials.description": "ブラウザーでこれらの URL を開くときに必要です",
  "settings.webui.section.urls": "アクセス URL",
  "settings.webui.urls.empty": "サーバーを開始すると共有可能な URL が表示されます",
  "settings.webui.section.connections": "接続中のクライアント",
  "settings.webui.connections.empty": "接続中のクライアントはありません",
  "settings.webui.connections.requests": "{{count}} 件のリクエスト",
  "settings.webui.error.start": "Web UI サーバーの開始に失敗しました",
  "settings.webui.error.stop": "Web UI サーバーの停止に失敗しました",
