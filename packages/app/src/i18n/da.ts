export const dict = {
  ...
  "settings.webui.server.description": "Udstiller OpenCodes webgrænseflade, så andre enheder på netværket kan oprette forbindelse",
  "settings.webui.status.running": "Kører",
  "settings.webui.status.stopped": "Stoppet",
  "settings.webui.action.start": "Start",
  "settings.webui.action.stop": "Stop",
  "settings.webui.hostname.title": "Lytteadresse",
  "settings.webui.hostname.description": "Netværksinterface, som Web UI lytter på",
  "settings.webui.hostname.all": "Alle interfaces (0.0.0.0)",
  "settings.webui.hostname.local": "Kun denne enhed (127.0.0.1)",
  "settings.webui.port.title": "Port",
  "settings.webui.port.description": "Port til Web UI. Brug 0 for automatisk at vælge en ledig port",
  "settings.webui.mdns.title": "mDNS-opdagelse",
  "settings.webui.mdns.description": "Annoncér Web UI på det lokale netværk via mDNS",
  "settings.webui.username.title": "Brugernavn",
  "settings.webui.username.description": "Brugernavn til login i Web UI",
  "settings.webui.password.title": "Adgangskode",
  "settings.webui.password.description": "Lad stå tomt for at tillade adgang uden login",
  "settings.webui.restart.hint": "Ændringer af disse indstillinger træder i kraft, når serveren stoppes og startes igen",
  "settings.webui.auth.warning": "Der er ikke angivet en adgangskode. Alle, der kan nå disse URL'er, kan styre OpenCode. Angiv miljøvariablen OPENCODE_SERVER_PASSWORD for at kræve login.",
  "settings.webui.credentials.title": "Loginoplysninger",
  "settings.webui.credentials.description": "Kræves, når disse URL'er åbnes i en browser",
  "settings.webui.section.urls": "Adgangs-URL'er",
  "settings.webui.urls.empty": "Start serveren for at få URL'er, der kan deles",
  "settings.webui.section.connections": "Forbundne klienter",
  "settings.webui.connections.empty": "Ingen klienter er forbundet",
  "settings.webui.connections.requests": "{{count}} forespørgsler",
