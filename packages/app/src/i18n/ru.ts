export const dict = {
  ...
  "settings.webui.server.title": "Сервер Web UI",
  "settings.webui.server.description": "Предоставляет веб-интерфейс OpenCode, чтобы другие устройства в сети могли подключаться",
  "settings.webui.status.running": "Работает",
  "settings.webui.status.stopped": "Остановлен",
  "settings.webui.action.start": "Запустить",
  "settings.webui.action.stop": "Остановить",
  "settings.webui.hostname.title": "Адрес прослушивания",
  "settings.webui.hostname.description": "Сетевой интерфейс, на котором работает Web UI",
  "settings.webui.hostname.all": "Все интерфейсы (0.0.0.0)",
  "settings.webui.hostname.local": "Только это устройство (127.0.0.1)",
  "settings.webui.port.title": "Порт",
  "settings.webui.port.description": "Порт Web UI. Укажите 0, чтобы автоматически выбрать свободный порт",
  "settings.webui.mdns.title": "Обнаружение mDNS",
  "settings.webui.mdns.description": "Анонсировать Web UI в локальной сети через mDNS",
  "settings.webui.username.title": "Имя пользователя",
  "settings.webui.username.description": "Имя пользователя для входа в Web UI",
  "settings.webui.password.title": "Пароль",
  "settings.webui.password.description": "Оставьте пустым, чтобы разрешить доступ без входа",
  "settings.webui.restart.hint": "Изменения этих настроек применяются после остановки и повторного запуска сервера",
  "settings.webui.auth.warning": "Пароль не задан. Любой, кто может открыть эти URL, может управлять OpenCode. Задайте переменную окружения OPENCODE_SERVER_PASSWORD, чтобы требовать вход.",
  "settings.webui.credentials.title": "Учётные данные для входа",
  "settings.webui.credentials.description": "Потребуются при открытии этих URL в браузере",
  "settings.webui.section.urls": "URL доступа",
  "settings.webui.urls.empty": "Запустите сервер, чтобы получить ссылки для доступа",
  "settings.webui.section.connections": "Подключённые клиенты",
  "settings.webui.connections.empty": "Нет подключённых клиентов",
  "settings.webui.connections.requests": "Запросов: {{count}}",
  "settings.webui.error.start": "Не удалось запустить сервер Web UI",
  "settings.webui.error.stop": "Не удалось остановить сервер Web UI",
