export const dict = {
  ...
  "settings.webui.server.title": "Web UI 서버",
  "settings.webui.server.description": "OpenCode 웹 인터페이스를 제공하여 네트워크의 다른 기기에서 접속할 수 있게 합니다",
  "settings.webui.status.running": "실행 중",
  "settings.webui.status.stopped": "중지됨",
  "settings.webui.action.start": "시작",
  "settings.webui.action.stop": "중지",
  "settings.webui.hostname.title": "수신 주소",
  "settings.webui.hostname.description": "Web UI가 수신 대기할 네트워크 인터페이스",
  "settings.webui.hostname.all": "모든 인터페이스 (0.0.0.0)",
  "settings.webui.hostname.local": "이 기기만 (127.0.0.1)",
  "settings.webui.port.title": "포트",
  "settings.webui.port.description": "Web UI 포트. 0을 입력하면 빈 포트를 자동 선택합니다",
  "settings.webui.mdns.title": "mDNS 검색",
  "settings.webui.mdns.description": "로컬 네트워크에서 mDNS로 Web UI를 알립니다",
  "settings.webui.username.title": "사용자 이름",
  "settings.webui.username.description": "Web UI 로그인에 사용할 사용자 이름",
  "settings.webui.password.title": "비밀번호",
  "settings.webui.password.description": "비워 두면 로그인 없이 접근할 수 있습니다",
  "settings.webui.restart.hint": "이 설정은 서버를 중지했다가 다시 시작하면 적용됩니다",
  "settings.webui.auth.warning": "비밀번호가 설정되지 않았습니다. 이 URL에 접근할 수 있는 누구나 OpenCode를 제어할 수 있습니다. 로그인을 요구하려면 OPENCODE_SERVER_PASSWORD 환경 변수를 설정하세요.",
  "settings.webui.credentials.title": "로그인 자격 증명",
  "settings.webui.credentials.description": "브라우저에서 이 URL을 열 때 필요합니다",
  "settings.webui.section.urls": "접속 URL",
  "settings.webui.urls.empty": "서버를 시작하면 공유 가능한 URL이 표시됩니다",
  "settings.webui.section.connections": "연결된 클라이언트",
  "settings.webui.connections.empty": "연결된 클라이언트가 없습니다",
  "settings.webui.connections.requests": "요청 {{count}}회",
  "settings.webui.error.start": "Web UI 서버 시작에 실패했습니다",
  "settings.webui.error.stop": "Web UI 서버 중지에 실패했습니다",
