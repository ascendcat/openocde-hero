export const dict = {
  ...
  "settings.webui.server.description": "Omogućava OpenCode web interfejs kako bi se drugi uređaji na mreži mogli povezati",
  "settings.webui.status.running": "Pokrenut",
  "settings.webui.status.stopped": "Zaustavljen",
  "settings.webui.action.start": "Pokreni",
  "settings.webui.action.stop": "Zaustavi",
  "settings.webui.hostname.title": "Adresa slušanja",
  "settings.webui.hostname.description": "Mrežni interfejs na kojem Web UI sluša",
  "settings.webui.hostname.all": "Svi interfejsi (0.0.0.0)",
  "settings.webui.hostname.local": "Samo ovaj uređaj (127.0.0.1)",
  "settings.webui.port.title": "Port",
  "settings.webui.port.description": "Port za Web UI. Unesite 0 za automatski odabir slobodnog porta",
  "settings.webui.mdns.title": "mDNS otkrivanje",
  "settings.webui.mdns.description": "Oglašava Web UI na lokalnoj mreži putem mDNS-a",
  "settings.webui.username.title": "Korisničko ime",
  "settings.webui.username.description": "Korisničko ime za prijavu na Web UI",
  "settings.webui.password.title": "Lozinka",
  "settings.webui.password.description": "Ostavite prazno da dozvolite pristup bez prijave",
  "settings.webui.restart.hint": "Promjene ovih postavki primjenjuju se nakon zaustavljanja i ponovnog pokretanja servera",
  "settings.webui.auth.warning": "Lozinka nije postavljena. Svako ko može pristupiti ovim URL-ovima može upravljati OpenCodeom. Postavite varijablu okruženja OPENCODE_SERVER_PASSWORD da zahtijevate prijavu.",
  "settings.webui.credentials.title": "Podaci za prijavu",
  "settings.webui.credentials.description": "Potrebni pri otvaranju ovih URL-ova u pregledaču",
  "settings.webui.section.urls": "URL-ovi za pristup",
  "settings.webui.urls.empty": "Pokrenite server da dobijete URL-ove za dijeljenje",
  "settings.webui.section.connections": "Povezani klijenti",
  "settings.webui.connections.empty": "Nema povezanih klijenata",
  "settings.webui.connections.requests": "{{count}} zahtjeva",
  "settings.webui.error.start": "Pokretanje Web UI servera nije uspjelo",
  "settings.webui.error.stop": "Zaustavljanje Web UI servera nije uspjelo",
