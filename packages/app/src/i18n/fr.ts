export const dict = {
  ...
  "settings.webui.server.title": "Serveur Web UI",
  "settings.webui.server.description": "Expose l'interface web d'OpenCode pour que d'autres appareils du réseau puissent s'y connecter",
  "settings.webui.status.running": "En cours d'exécution",
  "settings.webui.status.stopped": "Arrêté",
  "settings.webui.action.start": "Démarrer",
  "settings.webui.action.stop": "Arrêter",
  "settings.webui.hostname.title": "Adresse d'écoute",
  "settings.webui.hostname.description": "Interface réseau sur laquelle la Web UI écoute",
  "settings.webui.hostname.all": "Toutes les interfaces (0.0.0.0)",
  "settings.webui.hostname.local": "Cet appareil uniquement (127.0.0.1)",
  "settings.webui.port.title": "Port",
  "settings.webui.port.description": "Port de la Web UI. 0 choisit automatiquement un port libre",
  "settings.webui.mdns.title": "Découverte mDNS",
  "settings.webui.mdns.description": "Annonce la Web UI sur le réseau local via mDNS",
  "settings.webui.username.title": "Nom d'utilisateur",
  "settings.webui.username.description": "Nom d'utilisateur pour se connecter à la Web UI",
  "settings.webui.password.title": "Mot de passe",
  "settings.webui.password.description": "Laisser vide pour autoriser l'accès sans connexion",
  "settings.webui.restart.hint": "Les modifications de ces réglages s'appliquent après un arrêt puis un redémarrage du serveur",
  "settings.webui.auth.warning": "Aucun mot de passe n'est défini. Quiconque peut atteindre ces URL peut contrôler OpenCode. Définissez la variable d'environnement OPENCODE_SERVER_PASSWORD pour exiger une connexion.",
  "settings.webui.credentials.title": "Identifiants de connexion",
  "settings.webui.credentials.description": "Requis pour ouvrir ces URL dans un navigateur",
  "settings.webui.section.urls": "URL d'accès",
  "settings.webui.urls.empty": "Démarrez le serveur pour obtenir des URL partageables",
  "settings.webui.section.connections": "Clients connectés",
  "settings.webui.connections.empty": "Aucun client connecté",
  "settings.webui.connections.requests": "{{count}} requêtes",
  "settings.webui.error.start": "Échec du démarrage du serveur Web UI",
  "settings.webui.error.stop": "Échec de l'arrêt du serveur Web UI",
