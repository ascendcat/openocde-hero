...
export const dict = {
  ...
  "settings.webui.server.title": "Web UI 服务",
  "settings.webui.server.description": "对外提供 OpenCode 网页界面，让网络中的其他设备接入",
  "settings.webui.status.running": "运行中",
  "settings.webui.status.stopped": "已停止",
  "settings.webui.action.start": "启动",
  "settings.webui.action.stop": "停止",
  "settings.webui.hostname.title": "监听地址",
  "settings.webui.hostname.description": "Web UI 监听的网络接口",
  "settings.webui.hostname.all": "所有网卡 (0.0.0.0)",
  "settings.webui.hostname.local": "仅本机 (127.0.0.1)",
  "settings.webui.port.title": "端口",
  "settings.webui.port.description": "Web UI 使用的端口，填 0 表示自动选择空闲端口",
  "settings.webui.mdns.title": "mDNS 发现",
  "settings.webui.mdns.description": "在局域网内通过 mDNS 广播 Web UI",
  "settings.webui.username.title": "用户名",
  "settings.webui.username.description": "Web UI 登录用的用户名",
  "settings.webui.password.title": "密码",
  "settings.webui.password.description": "留空则无需登录即可访问",
  "settings.webui.restart.hint": "修改这些设置后需停止并重新启动服务才会生效",
  "settings.webui.auth.warning": "尚未设置密码，任何能访问这些链接的人都可以控制 OpenCode。请设置 OPENCODE_SERVER_PASSWORD 环境变量以启用登录验证。",
  "settings.webui.credentials.title": "登录凭据",
  "settings.webui.credentials.description": "在浏览器打开上述链接时需要输入",
  "settings.webui.section.urls": "访问链接",
  "settings.webui.urls.empty": "启动服务后即可获得可分享的链接",
  "settings.webui.section.connections": "已连接的客户端",
  "settings.webui.connections.empty": "暂无客户端连接",
  "settings.webui.connections.requests": "{{count}} 次请求",
  "settings.webui.error.start": "启动 Web UI 服务失败",
  "settings.webui.error.stop": "停止 Web UI 服务失败",
