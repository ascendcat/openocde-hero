...
export const dict = {
  ...
  "settings.webui.server.title": "Web UI sunucusu",
  "settings.webui.server.description": "Ağdaki diğer cihazların bağlanabilmesi için OpenCode web arayüzünü sunar",
  "settings.webui.status.running": "Çalışıyor",
  "settings.webui.status.stopped": "Durduruldu",
  "settings.webui.action.start": "Başlat",
  "settings.webui.action.stop": "Durdur",
  "settings.webui.hostname.title": "Dinleme adresi",
  "settings.webui.hostname.description": "Web UI'nin dinlediği ağ arabirimi",
  "settings.webui.hostname.all": "Tüm arabirimler (0.0.0.0)",
  "settings.webui.hostname.local": "Yalnızca bu cihaz (127.0.0.1)",
  "settings.webui.port.title": "Bağlantı noktası",
  "settings.webui.port.description": "Web UI bağlantı noktası. Boş bir bağlantı noktasını otomatik seçmek için 0 girin",
  "settings.webui.mdns.title": "mDNS keşfi",
  "settings.webui.mdns.description": "Web UI'yi yerel ağda mDNS ile duyurur",
  "settings.webui.username.title": "Kullanıcı adı",
  "settings.webui.username.description": "Web UI oturum açma kullanıcı adı",
  "settings.webui.password.title": "Parola",
  "settings.webui.password.description": "Oturum açmadan erişime izin vermek için boş bırakın",
  "settings.webui.restart.hint": "Bu ayarlardaki değişiklikler sunucu durdurulup yeniden başlatıldığında uygulanır",
  "settings.webui.auth.warning": "Parola ayarlanmamış. Bu URL'lere erişebilen herkes OpenCode'u kontrol edebilir. Oturum açmayı zorunlu kılmak için OPENCODE_SERVER_PASSWORD ortam değişkenini ayarlayın.",
  "settings.webui.credentials.title": "Oturum açma bilgileri",
  "settings.webui.credentials.description": "Bu URL'leri tarayıcıda açarken gereklidir",
  "settings.webui.section.urls": "Erişim URL'leri",
  "settings.webui.urls.empty": "Paylaşılabilir URL'ler almak için sunucuyu başlatın",
  "settings.webui.section.connections": "Bağlı istemciler",
  "settings.webui.connections.empty": "Bağlı istemci yok",
  "settings.webui.connections.requests": "{{count}} istek",
  "settings.webui.error.start": "Web UI sunucusu başlatılamadı",
  "settings.webui.error.stop": "Web UI sunucusu durdurulamadı",
