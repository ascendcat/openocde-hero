...
export const dict = {
  ...
  "settings.webui.server.title": "Web UI 伺服器",
  "settings.webui.server.description": "對外提供 OpenCode 網頁介面，讓網路上的其他裝置連入",
  "settings.webui.status.running": "執行中",
  "settings.webui.status.stopped": "已停止",
  "settings.webui.action.start": "啟動",
  "settings.webui.action.stop": "停止",
  "settings.webui.hostname.title": "監聽位址",
  "settings.webui.hostname.description": "Web UI 監聽的網路介面",
  "settings.webui.hostname.all": "所有介面 (0.0.0.0)",
  "settings.webui.hostname.local": "僅限本機 (127.0.0.1)",
  "settings.webui.port.title": "連接埠",
  "settings.webui.port.description": "Web UI 使用的連接埠，填 0 表示自動選擇空閒連接埠",
  "settings.webui.mdns.title": "mDNS 探索",
  "settings.webui.mdns.description": "在區域網路內透過 mDNS 廣播 Web UI",
  "settings.webui.username.title": "使用者名稱",
  "settings.webui.username.description": "Web UI 登入用的使用者名稱",
  "settings.webui.password.title": "密碼",
  "settings.webui.password.description": "留空則無需登入即可存取",
  "settings.webui.restart.hint": "修改這些設定後需停止並重新啟動伺服器才會生效",
  "settings.webui.auth.warning": "尚未設定密碼，任何能存取這些連結的人都可以控制 OpenCode。請設定 OPENCODE_SERVER_PASSWORD 環境變數以要求登入。",
  "settings.webui.credentials.title": "登入憑證",
  "settings.webui.credentials.description": "在瀏覽器開啟上述連結時需要輸入",
  "settings.webui.section.urls": "存取連結",
  "settings.webui.urls.empty": "啟動伺服器後即可取得可分享的連結",
  "settings.webui.section.connections": "已連線的用戶端",
  "settings.webui.connections.empty": "目前沒有用戶端連線",
  "settings.webui.connections.requests": "{{count}} 次要求",
  "settings.webui.error.start": "啟動 Web UI 伺服器失敗",
  "settings.webui.error.stop": "停止 Web UI 伺服器失敗",
