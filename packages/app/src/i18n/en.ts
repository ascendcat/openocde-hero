...
export const dict = {
  ...
  "settings.webui.server.description": "Serve the OpenCode web interface so other devices on your network can connect",
  "settings.webui.status.running": "Running",
  "settings.webui.status.stopped": "Stopped",
  "settings.webui.action.start": "Start",
  "settings.webui.action.stop": "Stop",
  "settings.webui.hostname.title": "Listen address",
  "settings.webui.hostname.description": "Network interface the web UI listens on",
  "settings.webui.hostname.all": "All interfaces (0.0.0.0)",
  "settings.webui.hostname.local": "This device only (127.0.0.1)",
  "settings.webui.port.title": "Port",
  "settings.webui.port.description": "Port for the web UI. Use 0 to pick any free port",
  "settings.webui.mdns.title": "mDNS discovery",
  "settings.webui.mdns.description": "Advertise the web UI on the local network",
  "settings.webui.username.title": "Username",
  "settings.webui.username.description": "Basic auth username for the web UI",
  "settings.webui.password.title": "Password",
  "settings.webui.password.description": "Leave empty to allow access without signing in",
  "settings.webui.restart.hint": "Changes to these settings apply after the server is stopped and started again",
  "settings.webui.auth.warning": "No password is set. Anyone who can reach these URLs can control OpenCode. Set the OPENCODE_SERVER_PASSWORD environment variable to require sign-in.",
  "settings.webui.credentials.title": "Sign-in credentials",
  "settings.webui.credentials.description": "Required when opening these URLs from a browser",
  "settings.webui.section.urls": "Access URLs",
  "settings.webui.urls.empty": "Start the server to get shareable URLs",
  "settings.webui.section.connections": "Connected clients",
  "settings.webui.connections.empty": "No clients are connected",
  "settings.webui.connections.requests": "{{count}} requests",
  "settings.webui.error.start": "Failed to start the web UI server",
  "settings.webui.error.stop": "Failed to stop the web UI server",
