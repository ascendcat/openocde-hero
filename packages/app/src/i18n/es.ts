export const dict = {
  ...
  "app.name.desktop": "OpenCode Hero",

  "settings.section.desktop": "Escritorio",
  "settings.section.server": "Servidor",
  "settings.tab.general": "General",
  "settings.tab.shortcuts": "Atajos",
  "settings.tab.webui": "Web UI",
  "settings.webui.server.title": "Servidor de Web UI",
  "settings.webui.server.description": "Sirve la interfaz web de OpenCode para que otros dispositivos de tu red puedan conectarse",
  "settings.webui.status.running": "En ejecución",
  "settings.webui.status.stopped": "Detenido",
  "settings.webui.action.start": "Iniciar",
  "settings.webui.action.stop": "Detener",
  "settings.webui.hostname.title": "Dirección de escucha",
  "settings.webui.hostname.description": "Interfaz de red en la que escucha la Web UI",
  "settings.webui.hostname.all": "Todas las interfaces (0.0.0.0)",
  "settings.webui.hostname.local": "Solo este dispositivo (127.0.0.1)",
  "settings.webui.port.title": "Puerto",
  "settings.webui.port.description": "Puerto de la Web UI. Usa 0 para elegir un puerto libre automáticamente",
  "settings.webui.mdns.title": "Descubrimiento mDNS",
  "settings.webui.mdns.description": "Anuncia la Web UI en la red local mediante mDNS",
  "settings.webui.username.title": "Nombre de usuario",
  "settings.webui.username.description": "Nombre de usuario para iniciar sesión en la Web UI",
  "settings.webui.password.title": "Contraseña",
  "settings.webui.password.description": "Déjala vacía para permitir el acceso sin iniciar sesión",
  "settings.webui.restart.hint": "Los cambios en estos ajustes se aplican tras detener y volver a iniciar el servidor",
  "settings.webui.auth.warning": "No hay contraseña configurada. Cualquiera que pueda acceder a estas URL puede controlar OpenCode. Define la variable de entorno OPENCODE_SERVER_PASSWORD para exigir inicio de sesión.",
  "settings.webui.credentials.title": "Credenciales de acceso",
  "settings.webui.credentials.description": "Necesarias al abrir estas URL en un navegador",
  "settings.webui.section.urls": "URL de acceso",
  "settings.webui.urls.empty": "Inicia el servidor para obtener URL compartibles",
  "settings.webui.section.connections": "Clientes conectados",
  "settings.webui.connections.empty": "No hay clientes conectados",
  "settings.webui.connections.requests": "{{count}} solicitudes",
  "settings.webui.error.start": "No se pudo iniciar el servidor de Web UI",
  "settings.webui.error.stop": "No se pudo detener el servidor de Web UI",
