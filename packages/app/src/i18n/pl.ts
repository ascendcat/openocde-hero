export const dict = {
  ...
  "settings.webui.server.title": "Serwer Web UI",
  "settings.webui.server.description": "Udostępnia interfejs webowy OpenCode, aby inne urządzenia w sieci mogły się połączyć",
  "settings.webui.status.running": "Działa",
  "settings.webui.status.stopped": "Zatrzymany",
  "settings.webui.action.start": "Uruchom",
  "settings.webui.action.stop": "Zatrzymaj",
  "settings.webui.hostname.title": "Adres nasłuchiwania",
  "settings.webui.hostname.description": "Interfejs sieciowy, na którym nasłuchuje Web UI",
  "settings.webui.hostname.all": "Wszystkie interfejsy (0.0.0.0)",
  "settings.webui.hostname.local": "Tylko to urządzenie (127.0.0.1)",
  "settings.webui.port.title": "Port",
  "settings.webui.port.description": "Port Web UI. Wpisz 0, aby automatycznie wybrać wolny port",
  "settings.webui.mdns.title": "Wykrywanie mDNS",
  "settings.webui.mdns.description": "Rozgłaszaj Web UI w sieci lokalnej przez mDNS",
  "settings.webui.username.title": "Nazwa użytkownika",
  "settings.webui.username.description": "Nazwa użytkownika do logowania w Web UI",
  "settings.webui.password.title": "Hasło",
  "settings.webui.password.description": "Pozostaw puste, aby zezwolić na dostęp bez logowania",
  "settings.webui.restart.hint": "Zmiany tych ustawień zostaną zastosowane po zatrzymaniu i ponownym uruchomieniu serwera",
  "settings.webui.auth.warning": "Nie ustawiono hasła. Każdy, kto może otworzyć te adresy URL, może sterować OpenCode. Ustaw zmienną środowiskową OPENCODE_SERVER_PASSWORD, aby wymagać logowania.",
  "settings.webui.credentials.title": "Dane logowania",
  "settings.webui.credentials.description": "Wymagane przy otwieraniu tych adresów URL w przeglądarce",
  "settings.webui.section.urls": "Adresy URL dostępu",
  "settings.webui.urls.empty": "Uruchom serwer, aby uzyskać adresy URL do udostępnienia",
  "settings.webui.section.connections": "Połączeni klienci",
  "settings.webui.connections.empty": "Brak połączonych klientów",
  "settings.webui.connections.requests": "Liczba żądań: {{count}}",
  "settings.webui.error.start": "Nie udało się uruchomić serwera Web UI",
  "settings.webui.error.stop": "Nie udało się zatrzymać serwera Web UI",
