export const dict = {
  ...
  "settings.webui.server.title": "เซิร์ฟเวอร์ Web UI",
  "settings.webui.server.description": "ให้บริการหน้าเว็บของ OpenCode เพื่อให้อุปกรณ์อื่นในเครือข่ายเชื่อมต่อได้",
  "settings.webui.status.running": "กำลังทำงาน",
  "settings.webui.status.stopped": "หยุดแล้ว",
  "settings.webui.action.start": "เริ่ม",
  "settings.webui.action.stop": "หยุด",
  "settings.webui.hostname.title": "ที่อยู่รับฟัง",
  "settings.webui.hostname.description": "อินเทอร์เฟซเครือข่ายที่ Web UI รับฟัง",
  "settings.webui.hostname.all": "ทุกอินเทอร์เฟซ (0.0.0.0)",
  "settings.webui.hostname.local": "เฉพาะเครื่องนี้ (127.0.0.1)",
  "settings.webui.port.title": "พอร์ต",
  "settings.webui.port.description": "พอร์ตของ Web UI ใส่ 0 เพื่อเลือกพอร์ตว่างโดยอัตโนมัติ",
  "settings.webui.mdns.title": "การค้นหา mDNS",
  "settings.webui.mdns.description": "ประกาศ Web UI ในเครือข่ายท้องถิ่นผ่าน mDNS",
  "settings.webui.username.title": "ชื่อผู้ใช้",
  "settings.webui.username.description": "ชื่อผู้ใช้สำหรับเข้าสู่ระบบ Web UI",
  "settings.webui.password.title": "รหัสผ่าน",
  "settings.webui.password.description": "เว้นว่างเพื่ออนุญาตให้เข้าถึงโดยไม่ต้องเข้าสู่ระบบ",
  "settings.webui.restart.hint": "การเปลี่ยนแปลงการตั้งค่าเหล่านี้จะมีผลหลังจากหยุดแล้วเริ่มเซิร์ฟเวอร์ใหม่",
  "settings.webui.auth.warning": "ยังไม่ได้ตั้งรหัสผ่าน ทุกคนที่เข้าถึง URL เหล่านี้ได้สามารถควบคุม OpenCode ได้ ตั้งค่าตัวแปรสภาพแวดล้อม OPENCODE_SERVER_PASSWORD เพื่อบังคับให้เข้าสู่ระบบ",
  "settings.webui.credentials.title": "ข้อมูลเข้าสู่ระบบ",
  "settings.webui.credentials.description": "จำเป็นเมื่อเปิด URL เหล่านี้ในเบราว์เซอร์",
  "settings.webui.section.urls": "URL สำหรับเข้าถึง",
  "settings.webui.urls.empty": "เริ่มเซิร์ฟเวอร์เพื่อรับ URL ที่แชร์ได้",
  "settings.webui.section.connections": "ไคลเอนต์ที่เชื่อมต่อ",
  "settings.webui.connections.empty": "ไม่มีไคลเอนต์เชื่อมต่อ",
  "settings.webui.connections.requests": "{{count}} คำขอ",
  "settings.webui.error.start": "ไม่สามารถเริ่มเซิร์ฟเวอร์ Web UI ได้",
  "settings.webui.error.stop": "ไม่สามารถหยุดเซิร์ฟเวอร์ Web UI ได้",
