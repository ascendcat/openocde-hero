...
export const dict = {
  ...
  "settings.webui.server.description": "Tilbyr OpenCodes webgrensesnitt slik at andre enheter på nettverket kan koble til",
  "settings.webui.status.running": "Kjører",
  "settings.webui.status.stopped": "Stoppet",
  "settings.webui.action.start": "Start",
  "settings.webui.action.stop": "Stopp",
  "settings.webui.hostname.title": "Lytteadresse",
  "settings.webui.hostname.description": "Nettverksgrensesnittet Web UI lytter på",
  "settings.webui.hostname.all": "Alle grensesnitt (0.0.0.0)",
  "settings.webui.hostname.local": "Kun denne enheten (127.0.0.1)",
  "settings.webui.port.title": "Port",
  "settings.webui.port.description": "Port for Web UI. Bruk 0 for å velge en ledig port automatisk",
  "settings.webui.mdns.title": "mDNS-oppdagelse",
  "settings.webui.mdns.description": "Annonser Web UI på lokalnettet via mDNS",
  "settings.webui.username.title": "Brukernavn",
  "settings.webui.username.description": "Brukernavn for pålogging i Web UI",
  "settings.webui.password.title": "Passord",
  "settings.webui.password.description": "La stå tomt for å tillate tilgang uten pålogging",
  "settings.webui.restart.hint": "Endringer i disse innstillingene trer i kraft etter at serveren stoppes og startes på nytt",
  "settings.webui.auth.warning": "Ingen passord er satt. Alle som kan nå disse URL-ene, kan styre OpenCode. Sett miljøvariabelen OPENCODE_SERVER_PASSWORD for å kreve innlogging.",
  "settings.webui.credentials.title": "Påloggingsinformasjon",
  "settings.webui.credentials.description": "Kreves når disse URL-ene åpnes i en nettleser",
  "settings.webui.section.urls": "Tilgangs-URL-er",
  "settings.webui.urls.empty": "Start serveren for å få URL-er som kan deles",
  "settings.webui.section.connections": "Tilkoblede klienter",
  "settings.webui.connections.empty": "Ingen klienter er tilkoblet",
  "settings.webui.connections.requests": "{{count}} forespørsler",
  "settings.webui.error.start": "Kunne ikke starte Web UI-serveren",
  "settings.webui.error.stop": "Kunne ikke stoppe Web UI-serveren",
