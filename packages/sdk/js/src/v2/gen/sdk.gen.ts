...
import type {
  ...
  VcsStatusErrors,
  VcsStatusResponses,
  WebuiConnectionsErrors,
  WebuiConnectionsResponses,
  WebuiStartErrors,
  WebUiStartInput,
  WebuiStartResponses,
  WebuiStatusErrors,
  WebuiStatusResponses,
  WebuiStopErrors,
  WebuiStopResponses,
...
export class Webui extends HeyApiClient {
  /**
   * Get web UI status
   *
   * Get the status of the shareable web UI listener, including reachable URLs.
   */
  public status<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<WebuiStatusResponses, WebuiStatusErrors, ThrowOnError>({
      url: "/web-ui",
      ...options,
    })
  }
   ...
   * Start web UI
   *
   * Start an additional server listener that exposes the web UI, typically on the local network.
   */
  public start<ThrowOnError extends boolean = false>(
    parameters?: {
      webUiStartInput?: WebUiStartInput
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams([parameters], [{ args: [{ key: "webUiStartInput", map: "body" }] }])
    return (options?.client ?? this.client).post<WebuiStartResponses, WebuiStartErrors, ThrowOnError>({
      url: "/web-ui/start",
      ...options,
      ...params,
      headers: {
   ...
   * Stop web UI
   *
   * Stop the web UI listener and close all of its client connections.
   */
  public stop<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).post<WebuiStopResponses, WebuiStopErrors, ThrowOnError>({
      url: "/web-ui/stop",
      ...options,
    })
  }
  ...
  /**
   * List web UI connections
   *
   * List clients currently connected to the web UI listener.
   */
  public connections<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<WebuiConnectionsResponses, WebuiConnectionsErrors, ThrowOnError>({
...
export class OpencodeClient extends HeyApiClient {
  ...
  get webui(): Webui {
    return (this._webui ??= new Webui({ client: this.client }))
  }
