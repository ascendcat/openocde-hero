...
export type WebUiStatus = {
  /**
   * Whether the web UI listener is running
   */
  running: boolean
  hostname?: string
  /**
   * Port the web UI listener is bound to
   */
  port?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  /**
   * URLs where the web UI can be reached, including LAN addresses when bound to all interfaces
   */
  urls: Array<string>
  /**
   ...
   */
  mdns: boolean
  connectionCount: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  username?: string
  password?: string
}

export type WebUiStartInput = {
  hostname?: string
  /**
   * Port to bind, defaults to 4096 or any free port
   */
  port?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  mdns?: boolean
  mdnsDomain?: string
...
export type WebUiConnection = {
  ...
  remotePort: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  connectedAt: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
...
export type WebuiStatusError = WebuiStatusErrors[keyof WebuiStatusErrors]

export type WebuiStatusResponses = {
  /**
   * Current web UI listener status
   */
  200: WebUiStatus
}

export type WebuiStatusResponse = WebuiStatusResponses[keyof WebuiStatusResponses]

export type WebuiStartData = {
  body?: WebUiStartInput
  path?: never
  query?: never
  url: "/web-ui/start"
}

export type WebuiStartErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type WebuiStartError = WebuiStartErrors[keyof WebuiStartErrors]

export type WebuiStartResponses = {
  /**
   * Web UI listener status after starting
   */
  200: WebUiStatus
}

export type WebuiStartResponse = WebuiStartResponses[keyof WebuiStartResponses]

export type WebuiStopData = {
  body?: never
  path?: never
  query?: never
  url: "/web-ui/stop"
...
export type WebuiStopError = WebuiStopErrors[keyof WebuiStopErrors]

export type WebuiStopResponses = {
  /**
   * Web UI listener status after stopping
   */
  200: WebUiStatus
}

export type WebuiStopResponse = WebuiStopResponses[keyof WebuiStopResponses]

export type WebuiConnectionsData = {
  body?: never
  path?: never
  query?: never
  url: "/web-ui/connections"
}

export type WebuiConnectionsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type WebuiConnectionsError = WebuiConnectionsErrors[keyof WebuiConnectionsErrors]

export type WebuiConnectionsResponses = {
  /**
   * Currently open web UI client connections
   */
  200: Array<WebUiConnection>
}

export type WebuiConnectionsResponse = WebuiConnectionsResponses[keyof WebuiConnectionsResponses]
